...
// Dicebear avatar URL (generates a unique avatar per username, no API key needed)
...
<div class="main">
    ...
    <div class="profile-card">
        ...
        <div class="profile-info">
            ...
            <div class="profile-badge">Active session</div>
        </div>
    </div>
    ...
    <div class="stats-row">
        <div class="stat-card">
            ...
            <div class="stat-value" style="font-size:20px;margin-top:4px;"><?= htmlspecialchars($username) ?></div>
            <div class="stat-sub">Your account username</div>
        </div>
        <div class="stat-card">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value" style="font-size:20px;margin-top:4px;"><?= date('M Y') ?></div>
            <div class="stat-sub">Welcome to FileVault</div>
        </div>
    </div>
    ...
    <div class="welcome-box">
        ...
        <p>Head over to the upload page to manage your files. Your session is active and secure.</p>
