    ...
    <div class="container mx-auto max-w-6xl px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-gray-700 pb-12 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="home_internet.php" class="hover:text-amberRed transition">Home Internet</a></li>
                    <li><a href="corporate.php" class="hover:text-amberRed transition">Corporate Internet</a></li>
                    <li><a href="coverage.php" class="hover:text-amberRed transition">Coverage Area</a></li>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
            ...
            <div class="flex space-x-4 mt-4 md:mt-0">
                <a href="#" class="hover:text-blue-500 transition"><i class="fa-brands fa-facebook text-xl"></i></a>
                <a href="#" class="hover:text-blue-500 transition"><i class="fa-brands fa-linkedin text-xl"></i></a>
                <a href="#" class="hover:text-red-500 transition"><i class="fa-brands fa-youtube text-xl"></i></a>
            </div>
        </div>
    </div>
</footer>
