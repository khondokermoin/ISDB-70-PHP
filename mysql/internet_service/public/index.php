<?php
session_start(); // সেশন শুরু করা হলো যাতে লগইন চেক করা যায়
// 1. Include your database connection
require_once '../config/database.php';

// 2. Include your Package model
...
<section class="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-24 px-4 text-center">
    <div class="container mx-auto max-w-4xl">
        ...
        <div class="flex justify-center flex-wrap gap-4">
            ...
            <?php else: ?>
                <a href="login.php" class="bg-transparent border-2 border-white hover:bg-white hover:text-gray-900 text-white font-bold py-3 px-8 rounded shadow-lg transition transform hover:-translate-y-1">
