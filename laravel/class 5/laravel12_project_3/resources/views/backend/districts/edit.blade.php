    ...
    <div class="container-fluid px-3 px-lg-4 py-4">
        <div class="page-heading">
            <div class="page-heading-copy">
                ...
                <div>
                    ...
                    <h1 class="h3 mb-1">Edit District</h1>
                    <p class="text-muted mb-0">Modify the existing district name details below.</p>
                </div>
            </div>
        ...
        <section class="row g-3">
            <div class="col-12 col-xl-8">
                ...
                <form class="panel needs-validation" method="POST" novalidate action="{{ route('districts.update', $district->id) }}">
                    @csrf
                    ...
                    <div class="panel-header">
                        <div>
                            ...
                            <p class="text-muted mb-0">Update district name with validated fields.</p>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-end gap-2 mt-4">
                        ...
                        <button class="btn btn-primary" type="submit">
                            <i class="bi bi-check-circle" aria-hidden="true"></i> Update District
                        </button>
                    </div>
                </form>
            </div>
