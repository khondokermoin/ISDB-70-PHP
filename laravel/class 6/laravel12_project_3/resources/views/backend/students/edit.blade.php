        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
            ...
            <section class="row g-3">
                <div class="col-12 col-xl-8">
                    ...
                    @endif
                    <form class="panel needs-validation" method="POST" novalidate action="{{ route('students.update', $student->id) }}">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="fullName" name="fullName"
                                    value="{{ old('fullName', $student->name) }}" type="text" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="email" name="email"
                                    value="{{ old('email', $student->email) }}" type="email" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="phone" name="phone"
                                    value="{{ old('phone', $student->phone) }}" type="tel" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="gender"
                                        {{ old('gender', $student->gender) == 'male' ? 'checked' : '' }} id="genderMale"
                                        value="male" required>
                                    <label class="form-check-label" for="genderMale">Male</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="gender"
                                        {{ old('gender', $student->gender) == 'female' ? 'checked' : '' }} id="genderFemale"
                                        value="female" required>
                                    <label class="form-check-label" for="genderFemale">Female</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="gender"
                                        {{ old('gender', $student->gender) == 'other' ? 'checked' : '' }} id="genderOther"
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="district" name="district" required>
                                    ...
                                    <option value="2"
                                        {{ old('district', $student->district) == '2' ? 'selected' : '' }}>Barishal
                                    </option>
                                    <option value="3"
                                        {{ old('district', $student->district) == '3' ? 'selected' : '' }}>Khulna</option>
                                    <option value="4"
                                        {{ old('district', $student->district) == '4' ? 'selected' : '' }}>Chittagong
                                    </option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="subjects[]" id="subjectPhp"
                                        value="php" />
                                    <label class="form-check-label" for="subjectPhp">PHP</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="subjects[]" id="subjectJava"
                                        value="java" />
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="subjects[]"
                                        id="subjectLaravel" value="laravel" />
                                    <label class="form-check-label" for="subjectLaravel">Laravel</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="subjects[]" id="subjectKotlin"
                                        value="kotlin" />
                        ...
                        <div class="d-flex flex-wrap justify-content-end gap-2 mt-4">
                            ...
                            <button class="btn btn-primary" type="submit"><i class="bi bi-person-check"
                                    aria-hidden="true"></i> Update Student</button>
                        </div>
                    </form>
                </div>
            </section>
