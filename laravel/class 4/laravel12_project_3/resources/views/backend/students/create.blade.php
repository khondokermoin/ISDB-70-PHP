                    ...
                    <form class="panel needs-validation" method="POST" novalidate action="{{ route('students.store') }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="subject" id="subjectPhp"
                                        value="php" />
                                    <label class="form-check-label" for="subjectPhp">PHP</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="subject" id="subjectJava"
                                        value="java" />
                                    <label class="form-check-label" for="subjectJava">Java</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="subject" id="subjectLaravel"
                                        value="laravel" />
                                    <label class="form-check-label" for="subjectLaravel">Laravel</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="subject" id="subjectKotlin"
                                        value="kotlin" />
