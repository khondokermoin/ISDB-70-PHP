...
<head>
    ...
    <style>
        body { font-family: Arial, sans-serif; margin: 0; background: #ddd; }
        ...
        .item { width: 180px; background: #fafafa; border: 1px solid #ddd; border-radius: 8px; padding: 10px; }
        .item img { width: 100%; height: 150px; object-fit: cover; border: 1px solid #ccc; background: white; margin-bottom: 8px; }
        .info { font-size: 13px; line-height: 1.6; word-break: break-word; }
    </style>
</head>
<body>
        ...
        <?php if ($files) { ?>
            <div class="gallery">
                <?php foreach ($files as $file) { ?>
                    ...
                    <?php $meta = $imageInfo[$savedName] ?? [
                        'name' => $savedName,
                        'type' => function_exists('mime_content_type') ? mime_content_type($file) : 'image',
                        'size' => filesize($file)
                    ]; ?>
                    <div class="item">
